...
export class GraphqlService {
    constructor(protected client: import("@apollo/client/core").ApolloClient<any>) {
    }

    async createCommunity(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<CreateCommunityMutation, CreateCommunityMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: CreateCommunityMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<CreateCommunityMutation,CreateCommunityMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async getCommunity(options: Omit<
                        Partial<import("@apollo/client/core").QueryOptions<GetCommunityQueryVariables, GetCommunityQuery>>,
                        "variables" | "query"
                      > & {
                        variables: GetCommunityQueryVariables
                      }) {
        ...
        const result = await this.client.query<GetCommunityQuery,GetCommunityQueryVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async getCritters(options: Omit<
                        Partial<import("@apollo/client/core").QueryOptions<GetCrittersQueryVariables, GetCrittersQuery>>,
                        "variables" | "query"
                      > & {
                        variables: GetCrittersQueryVariables
                      }) {
        ...
        const result = await this.client.query<GetCrittersQuery,GetCrittersQueryVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async getCommunityListView(options: Omit<
                        Partial<import("@apollo/client/core").QueryOptions<GetCommunityListViewQueryVariables, GetCommunityListViewQuery>>,
                        "variables" | "query"
                      > & {
                        variables: GetCommunityListViewQueryVariables
                      }) {
        ...
        const result = await this.client.query<GetCommunityListViewQuery,GetCommunityListViewQueryVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async createTraitListEntry(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<CreateTraitListEntryMutation, CreateTraitListEntryMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: CreateTraitListEntryMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<CreateTraitListEntryMutation,CreateTraitListEntryMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async deleteTraitListEntry(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<DeleteTraitListEntryMutation, DeleteTraitListEntryMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: DeleteTraitListEntryMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<DeleteTraitListEntryMutation,DeleteTraitListEntryMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async modifyTraitListEntry(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<ModifyTraitListEntryMutation, ModifyTraitListEntryMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: ModifyTraitListEntryMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<ModifyTraitListEntryMutation,ModifyTraitListEntryMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async createEnumValueSetting(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<CreateEnumValueSettingMutation, CreateEnumValueSettingMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: CreateEnumValueSettingMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<CreateEnumValueSettingMutation,CreateEnumValueSettingMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async createSpeciesImageUploadUrl(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<CreateSpeciesImageUploadUrlMutation, CreateSpeciesImageUploadUrlMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: CreateSpeciesImageUploadUrlMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<CreateSpeciesImageUploadUrlMutation,CreateSpeciesImageUploadUrlMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async createSpeciesTrait(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<CreateSpeciesTraitMutation, CreateSpeciesTraitMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: CreateSpeciesTraitMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<CreateSpeciesTraitMutation,CreateSpeciesTraitMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async createVariant(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<CreateVariantMutation, CreateVariantMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: CreateVariantMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<CreateVariantMutation,CreateVariantMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async deleteEnumValueSetting(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<DeleteEnumValueSettingMutation, DeleteEnumValueSettingMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: DeleteEnumValueSettingMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<DeleteEnumValueSettingMutation,DeleteEnumValueSettingMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async deleteTrait(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<DeleteTraitMutation, DeleteTraitMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: DeleteTraitMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<DeleteTraitMutation,DeleteTraitMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async getSpeciesDetail(options: Omit<
                        Partial<import("@apollo/client/core").QueryOptions<GetSpeciesDetailQueryVariables, GetSpeciesDetailQuery>>,
                        "variables" | "query"
                      > & {
                        variables: GetSpeciesDetailQueryVariables
                      }) {
        ...
        const result = await this.client.query<GetSpeciesDetailQuery,GetSpeciesDetailQueryVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async getSpeciesTraits(options: Omit<
                        Partial<import("@apollo/client/core").QueryOptions<GetSpeciesTraitsQueryVariables, GetSpeciesTraitsQuery>>,
                        "variables" | "query"
                      > & {
                        variables: GetSpeciesTraitsQueryVariables
                      }) {
        ...
        const result = await this.client.query<GetSpeciesTraitsQuery,GetSpeciesTraitsQueryVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async modifySpeciesTrait(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<ModifySpeciesTraitMutation, ModifySpeciesTraitMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: ModifySpeciesTraitMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<ModifySpeciesTraitMutation,ModifySpeciesTraitMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async createSpecies(options: Omit<
                        Partial<import("@apollo/client/core").MutationOptions<CreateSpeciesMutation, CreateSpeciesMutationVariables>>,
                        "variables" | "mutation"
                      > & {
                        variables: CreateSpeciesMutationVariables
                      }): 
        ...
        const result = await this.client.mutate<CreateSpeciesMutation,CreateSpeciesMutationVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }

    async getSpeciesListView(options: Omit<
                        Partial<import("@apollo/client/core").QueryOptions<GetSpeciesListViewQueryVariables, GetSpeciesListViewQuery>>,
                        "variables" | "query"
                      > & {
                        variables: GetSpeciesListViewQueryVariables
                      }) {
        ...
        const result = await this.client.query<GetSpeciesListViewQuery,GetSpeciesListViewQueryVariables>(finalOptions);
        if (!hasData(result)) { throw new Error("Unknown request failure") };
        return result;
    }
}
...
export function hasTypeName<T extends string>(val: any, typename: T): val is { __typeName: T } {
    return val && typeof val === "object" && val.__typename === typename
}
...
export type NarrowToAccount<T> = T extends { __typename ?: "Account" } ? T : never
;
...
export type NarrowToCommunity<T> = T extends { __typename ?: "Community" } ? T : never
;

export function isCommunityList(val: unknown): val is {__typename: "CommunityList"} {
    return hasTypeName(val, "CommunityList");
}

export type NarrowToCommunityList<T> = T extends { __typename ?: "CommunityList" } ? T : never
;
...
export type NarrowToCritter<T> = T extends { __typename ?: "Critter" } ? T : never
;

export function isDeleteResponse(val: unknown): val is {__typename: "DeleteResponse"} {
    return hasTypeName(val, "DeleteResponse");
}

export type NarrowToDeleteResponse<T> = T extends { __typename ?: "DeleteResponse" } ? T : never
;

export function isDuplicateError(val: unknown): val is {__typename: "DuplicateError"} {
    return hasTypeName(val, "DuplicateError");
}

export type NarrowToDuplicateError<T> = T extends { __typename ?: "DuplicateError" } ? T : never
;
...
export type NarrowToEnumValue<T> = T extends { __typename ?: "EnumValue" } ? T : never
;

export function isEnumValueSetting(val: unknown): val is {__typename: "EnumValueSetting"} {
    return hasTypeName(val, "EnumValueSetting");
}

export type NarrowToEnumValueSetting<T> = T extends { __typename ?: "EnumValueSetting" } ? T : never
;
...
export type NarrowToIdentity<T> = T extends { __typename ?: "Identity" } ? T : never
;

export function isInvalidArgumentError(val: unknown): val is {__typename: "InvalidArgumentError"} {
    return hasTypeName(val, "InvalidArgumentError");
}

export type NarrowToInvalidArgumentError<T> = T extends { __typename ?: "InvalidArgumentError" } ? T : never
;

export function isLoginResponse(val: unknown): val is {__typename: "LoginResponse"} {
    return hasTypeName(val, "LoginResponse");
}

export type NarrowToLoginResponse<T> = T extends { __typename ?: "LoginResponse" } ? T : never
;
...
export type NarrowToMutation<T> = T extends { __typename ?: "Mutation" } ? T : never
;

export function isNotFoundError(val: unknown): val is {__typename: "NotFoundError"} {
    return hasTypeName(val, "NotFoundError");
}

export type NarrowToNotFoundError<T> = T extends { __typename ?: "NotFoundError" } ? T : never
;
...
export type NarrowToSpecies<T> = T extends { __typename ?: "Species" } ? T : never
;

export function isSpeciesList(val: unknown): val is {__typename: "SpeciesList"} {
    return hasTypeName(val, "SpeciesList");
}

export type NarrowToSpeciesList<T> = T extends { __typename ?: "SpeciesList" } ? T : never
;
...
export type NarrowToTraitList<T> = T extends { __typename ?: "TraitList" } ? T : never
;

export function isTraitListEntry(val: unknown): val is {__typename: "TraitListEntry"} {
    return hasTypeName(val, "TraitListEntry");
}

export type NarrowToTraitListEntry<T> = T extends { __typename ?: "TraitListEntry" } ? T : never
;

export function isUrlResponse(val: unknown): val is {__typename: "UrlResponse"} {
    return hasTypeName(val, "UrlResponse");
}

export type NarrowToUrlResponse<T> = T extends { __typename ?: "UrlResponse" } ? T : never
;

export function isValidationConstraint(val: unknown): val is {__typename: "ValidationConstraint"} {
    return hasTypeName(val, "ValidationConstraint");
}

export type NarrowToValidationConstraint<T> = T extends { __typename ?: "ValidationConstraint" } ? T : never
;

export function isValidationError(val: unknown): val is {__typename: "ValidationError"} {
    return hasTypeName(val, "ValidationError");
}

export type NarrowToValidationError<T> = T extends { __typename ?: "ValidationError" } ? T : never
;

export function isBaseError(val: any): val is { __typename?: "DuplicateError" | "InvalidArgumentError" | "NotFoundError" } {
    return val && val.__typename && (val.__typename === "DuplicateError" || val.__typename === "InvalidArgumentError" || val.__typename === "NotFoundError")
}
